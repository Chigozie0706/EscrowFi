...
const features = [
  {
    icon: Shield,
    title: "Secure Escrow",
    description: "Smart contracts ensure funds are only released when work is completed and approved."
  },
  {
    icon: Zap,
    title: "Instant Payments",
    description: "Get paid instantly in SOL once the client approves your work. No waiting for bank transfers."
  },
  {
    icon: Globe,
    title: "Global Access",
    description: "Work with anyone, anywhere. No borders, no restrictions, no middlemen."
  },
  {
    icon: Lock,
    title: "Trustless System",
    description: "Built on Solana blockchain for transparent, immutable, and secure transactions."
  }
];
...
const testimonials = [
  {
    ...
    content: "EscrowFi completely changed how I work with clients. No more payment delays or disputes. Everything is transparent and secure.",
    rating: 5
  },
  {
    name: "Marcus Rodriguez",
    role: "Design Agency Owner",
    content: "The best platform for managing freelance payments. The smart contracts give both parties peace of mind.",
    rating: 5
  },
  {
    name: "Aisha Patel",
    role: "Web3 Developer",
    content: "Fast, secure, and incredibly easy to use. This is the future of freelance work.",
    rating: 5
  }
];
...
const faqs = [
  {
    ...
    answer: "EscrowFi uses Solana smart contracts to hold funds in escrow until work is completed. The client deposits funds, the freelancer completes the work and submits proof, and once approved, funds are automatically released."
  },
  {
    question: "What fees does EscrowFi charge?",
    answer: "We charge a flat 2.5% fee on all transactions, significantly lower than traditional platforms. Plus, you benefit from Solana's ultra-low gas fees."
  },
  {
    question: "How long does it take to receive payment?",
    answer: "Once a client approves your work, payment is released instantly. Funds appear in your Solana wallet within seconds."
  },
  {
    question: "Is my money safe?",
    answer: "Absolutely. All funds are held in audited smart contracts on the Solana blockchain. Neither party can access the funds until the agreed conditions are met."
  },
  {
    question: "Do I need crypto experience?",
    answer: "Not at all! We've designed EscrowFi to be user-friendly for everyone. If you can use a regular app, you can use EscrowFi."
  }
];
        ...
        <div className="container mx-auto px-6 py-24 md:py-32 relative">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              The decentralized escrow platform for Web3. Create secure jobs, submit work, and get paid instantly with zero trust required.
            </p>

            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link href="/dashboard/create-escrow">
                <Button size="lg" className="bg-[#7C3AED] hover:bg-[#6D31D4] h-12 px-8">
                  Create Escrow
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </Link>
              ...
              {[
                {
                  ...
                  description: "Client creates a job posting and deposits funds into a secure smart contract escrow."
                },
                {
                  step: "02",
                  title: "Freelancer Accepts Job",
                  description: "Freelancer browses available jobs and accepts the one that fits their skills."
                },
                {
                  step: "03",
                  title: "Work Completion",
                  description: "Freelancer completes the work and submits proof (code, files, demo links, etc.)."
                },
                {
                  step: "04",
                  title: "Payment Release",
                  description: "Client reviews and approves the work. Funds are instantly released to the freelancer."
                }
              ].map((item, index) => (
                <motion.div
                  key={item.step}
      ...
      <section id="testimonials" className="py-24">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold mb-4">Loved by Freelancers & Clients</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-[#14F195] text-[#14F195]" />
                  ))}
                </div>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join the future of freelance work. Create your first escrow in minutes.
            </p>
            <Link href="/dashboard">
              <Button size="lg" className="bg-[#7C3AED] hover:bg-[#6D31D4] h-14 px-10 text-lg">
                Launch App
